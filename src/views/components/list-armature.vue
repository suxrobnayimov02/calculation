    ...
    <div class="is-category">
      <div class="category-items">
        <router-link :to="{name: 'AllCategoryList'}">
          <el-button :type="$route.name == 'ArmatureList' ? 'primary' : 'success'" @click="allCategory" class="active-category">
            Все
          </el-button>
        </router-link>
        <div class="category-filter">
          <router-link :to="{name: 'WaterSupply'}">
            <el-button :type="$route.name == 'AllCategoryList' ? 'success' : 'primary'" class="active-category">
              Водоснабжения
            </el-button>
          </router-link>
        </div>
        <div class="category-filter">
          <router-link :to="{name: 'ArmatureList'}">
            <el-button :type="$route.name == 'ArmatureList' ? 'success' : 'primary'" class="active-category">
              Фитинги
            </el-button>
          </router-link>
        </div>
        <div class="category-filter">
          <router-link :to="{name: 'SewageList'}">
            <el-button :type="$route.name == 'AllCategory3' ? '' : 'primary'" class="active-category">
              Канализация
            </el-button>
          </router-link>
        </div>
